...
const components: Options["components"] = {
	...
	h1: ({ node, children, className, ...props }) => (
		<h1
			className={cn(
				"mt-6 mb-2 font-medium text-[56px] leading-[64px] tracking-[-0.01em]",
				className
			)}
			{...props}
		>
	...
	h2: ({ node, children, className, ...props }) => (
		<h2
			className={cn(
				"mt-6 mb-2 font-medium text-[48px] leading-[56px] tracking-[-0.01em]",
				className
			)}
			{...props}
		>
	...
	h3: ({ node, children, className, ...props }) => (
		<h3
			className={cn(
				"mt-6 mb-2 font-medium text-[40px] leading-[48px] tracking-[-0.01em]",
				className
			)}
			{...props}
		>
	...
	h4: ({ node, children, className, ...props }) => (
		<h4
			className={cn(
				"mt-6 mb-2 font-medium text-[32px] leading-[40px] tracking-[-0.005em]",
				className
			)}
			{...props}
		>
	...
	h5: ({ node, children, className, ...props }) => (
		<h5
			className={cn(
				"mt-6 mb-2 font-medium text-[24px] leading-[32px] tracking-normal",
				className
			)}
			{...props}
		>
	...
	h6: ({ node, children, className, ...props }) => (
		<h6
			className={cn(
				"mt-6 mb-2 font-medium text-[20px] leading-[28px] tracking-normal",
				className
			)}
			{...props}
		>
